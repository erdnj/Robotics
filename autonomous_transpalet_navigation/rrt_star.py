...
class RRTStar(RRT):
    ...
    def planning(self, animation=False):
        ...
        for i in range(self.max_iter):
            ...
            if(i==300 and len(self.node_list) == 1):
                return None
...
def get_rrt_star_path(start, goal, obs_info, show_animation=False):
    ...
    clean_path = [k for k, g in itertools.groupby(finded_path.tolist())]
    return clean_path
